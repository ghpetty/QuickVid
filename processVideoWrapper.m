...
switch appData.ROIType
    ...
    case 'N' % No cropping
        ...
        com = createFFmpegCommand(vidFilePath,outputProcessed,...
    ...
    case 'V'
        ...
        comLeft = createFFmpegCommand(vidFilePath,outputLeft,...
        ...
        comRight = createFFmpegCommand(vidFilePath,outputRight,...
    ...
    case 'H'
        ...
        comTop = createFFmpegCommand(vidFilePath,outputTop,...
        ...
        comBottom = createFFmpegCommand(vidFilePath,outputBottom,...
    ...
    case 'C'
        ...
        com = createFFmpegCommand(vidFilePath,outputCrop,...
